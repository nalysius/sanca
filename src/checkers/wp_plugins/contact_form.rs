...
/// The checker
pub struct ContactFormChecker<'a> {
...
impl<'a> ContactFormChecker<'a> {
    ...
    fn check_http_body(&self, url_response: &UrlResponse) -> Option<Finding> {
        trace!(
            "Running ContactFormChecker::check_http_body() on {}",
            url_response.url
        );
            ...
            .contains("/wp-content/plugins/contact-form-7/readme.txt")
        {
            let body_regex_params = self
                ...
                .expect("Regex ContactForm/http-body-source not found");
...
impl<'a> Checker for ContactFormChecker<'a> {}

impl<'a> HttpChecker for ContactFormChecker<'a> {
    /// Check for a HTTP scan.
    fn check_http(&self, data: &[UrlResponse]) -> Vec<Finding> {
        trace!("Running ContactFormChecker::check_http()");
...
mod tests {
    ...
    fn source_code_matches() {
        let checker = ContactFormChecker::new();
        let body1 = r#"=== Contact Form 7 ===
        ...
        Tested up to: 6.4
        Stable tag: 5.8.4"#;
        let url1 = "https://www.example.com/blog/wp-content/plugins/contact-form-7/readme.txt";
    ...
    fn source_code_doesnt_match() {
        let checker = ContactFormChecker::new();
        let body = r#"Contact form can be found in stable tag: 5.8.4"#;
    ...
    fn finds_match_in_url_responses() {
        ...
        Tested up to: 6.4
        Stable tag: 5.8.4"#;
        let url1 = "https://www.example.com/wp-content/plugins/contact-form-7/readme.txt";
        let url_response_valid =
            UrlResponse::new(url1, HashMap::new(), body1, UrlRequestType::Default, 200);
        let url_response_invalid = UrlResponse::new(
    ...
    fn doesnt_find_match_in_url_responses() {
        ...
        let body2 = r#"How to install Contact Form 5.8.4"#;
